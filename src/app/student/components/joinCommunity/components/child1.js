    ...
    <div className="w-full font-poppins max-w-md mx-auto hover:scale-105 transition-transform duration-500 shadow-md bg-white rounded-xl overflow-hidden md:max-w-3xl lg:max-w-4xl mt-4">
      <div className="md:flex md:flex-wrap">
        <div className="md:w-1/3 w-auto flex items-center justify-center">
          <img className="w-full h-full object-contain ml-4 mr-4" src={image} alt="Modern building architecture"/>
        </div>
        <div className="md:w-2/3 p-8 flex flex-col">
          ...
          <div className="flex justify-end mt-auto">
            <button
              className="bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 rounded-full focus:outline-none focus:shadow-outline-green transition-transform transform hover:scale-110 duration-300 ease-in-out"
