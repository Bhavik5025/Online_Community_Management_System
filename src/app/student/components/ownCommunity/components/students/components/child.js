...
//       </head>
//       <div
//         className="w-4/5 h-48 p-2 bg-white-200  
...
//             {dummy.working_location == undefined
//               ? "Free shipping"
//               : dummy.working_location}
//           </h6>
...
export default function Product(props) {
  ...
  <button
    onClick={handleDelete}
    className="text-white bg-red-500 mr-1 ml-1 hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-10 py-3 text-center mb-2"
    type="button"
  >
    Remove
  </button>
